...
<div class="container">
        <h2 class="text-center pt-4" style="color : black;"><i class="fa fa-exchange" aria-hidden="true"> </i> Transaction History</h2>
        <br>
            <div class="row">
                <div class="col">
                    ...
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered" style="border-color:black;">
                        <thead style="color : black;">
                            ...
                            <th scope="col" class="text-center py-2">Time Of Transaction</th>
                            </tr>
                        </thead>
                        <tbody>
                <?php 
